	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .widget-button > i'      => 'margin-left: {{SIZE}}{{UNIT}};',
					'.rtl {{WRAPPER}} .widget-button > i' => 'margin-left: 0; margin-right: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'icon_position' => 'after'
				]
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .widget-button i' => ' -webkit-transform: translateY({{SIZE}}{{UNIT}}); -ms-transform: translateY({{SIZE}}{{UNIT}}); transform: translateY({{SIZE}}{{UNIT}})',
				),
			)
		);
